...
return [
    ...
    | the validator class in French. You can modify these messages to suit
    ...
    */
    ...
    'required_array_keys' => 'Le champ :attribute doit contenir des entrées pour les valeurs : :values.',
    ...
    */
    ...
    'custom' => [
        'attribute-name' => [
            'rule-name' => 'Message de validation personnalisé',
        ],
    ],
