<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.settings.index') }}"><i
                        class="icon-speedometer"></i>{{ trans('sidebar.dashboard') }}<span
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.settings.index') }}"><i
                        class="icon-settings"></i>{{ trans('sidebar.settings') }}</a>
